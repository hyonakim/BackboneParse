...
var _customer_model = require('./customer_model');

var _customer_model2 = _interopRequireDefault(_customer_model);

var BankCustomers = _backbone2['default'].Collection.extend({

	url: 'https://api.parse.com/1/classes/HBank_Database',

	model: _customer_model2['default'],
...
exports['default'] = BankCustomers;
module.exports = exports['default'];

},{"./customer_model":2,"backbone":5}],2:[function(require,module,exports){
'use strict';
...
var CustomerModel = _backbone2['default'].Model.extend({
...
var _bankcustomers = require('./bankcustomers');

var _bankcustomers2 = _interopRequireDefault(_bankcustomers);

var _customer_template = require('./customer_template');

var _customer_template2 = _interopRequireDefault(_customer_template);

var AppID = 'SKr735usP97tondLKSCwlaMNVksDKYhAJ6uLYipK';
var RestAPI = '3VWR1hg6WIKEzMy6Y7pn9xx8JR0YGPL0KUIL35vQ';
...
var customers = new _bankcustomers2['default']();
...
function renderCustomers() {
	...
	customers.each(function (person) {
		...
		var $li = (0, _jquery2['default'])(templateStr);
